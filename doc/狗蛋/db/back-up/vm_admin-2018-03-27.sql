...
-- Records of vm_menus
-- ----------------------------
INSERT INTO `vm_menus` VALUES (3, '主页', NULL, 1, 1, 1, 1, 'homeMenu', NULL, 2, 'home');
INSERT INTO `vm_menus` VALUES (4, '主页', NULL, 1, 1, 1, 1, '/', 3, 1, NULL);
INSERT INTO `vm_menus` VALUES (5, '用户管理', NULL, 1, 1, 1, 1, 'userMenu', NULL, 2, 'user');
INSERT INTO `vm_menus` VALUES (6, '用户管理', NULL, 1, 1, 1, 1, '/user', 5, 1, '');
INSERT INTO `vm_menus` VALUES (7, '登录记录', NULL, 1, 1, 1, 1, '/user/login/logs', 5, 1, '');
INSERT INTO `vm_menus` VALUES (8, '电影管理', NULL, 1, 1, 1, 1, 'movieMenu', NULL, 2, 'play-circle-o');
INSERT INTO `vm_menus` VALUES (9, '电影管理', NULL, 1, 1, 1, 1, '/movie', 8, 1, NULL);
INSERT INTO `vm_menus` VALUES (10, '电影人管理', NULL, 1, 1, 1, 1, '/movie/filmmaker', 8, 1, NULL);
INSERT INTO `vm_menus` VALUES (11, '标签分组管理', NULL, 1, 1, 1, 1, '/movie/tagGroup', 8, 1, NULL);
INSERT INTO `vm_menus` VALUES (12, '管理员管理', NULL, 1, 1, 1, 1, 'adminMenu', NULL, 2, 'lock');
INSERT INTO `vm_menus` VALUES (13, '管理员管理', '', 1, 1, 1, 1, '/admin', 12, 1, NULL);
INSERT INTO `vm_menus` VALUES (14, '登录记录', NULL, 1, 1, 1, 1, '/admin/login/logs', 12, 1, NULL);
...
-- ----------------------------
INSERT INTO `vm_roles_menus_realation` VALUES (3, 1, 1, 1, 1, 1, 3);
INSERT INTO `vm_roles_menus_realation` VALUES (4, 1, 1, 1, 1, 1, 4);
INSERT INTO `vm_roles_menus_realation` VALUES (5, 1, 1, 1, 1, 1, 5);
INSERT INTO `vm_roles_menus_realation` VALUES (6, 1, 1, 1, 1, 1, 6);
INSERT INTO `vm_roles_menus_realation` VALUES (7, 1, 1, 1, 1, 1, 7);
INSERT INTO `vm_roles_menus_realation` VALUES (8, 1, 1, 1, 1, 1, 8);
INSERT INTO `vm_roles_menus_realation` VALUES (9, 1, 1, 1, 1, 1, 9);
INSERT INTO `vm_roles_menus_realation` VALUES (10, 1, 1, 1, 1, 1, 10);
INSERT INTO `vm_roles_menus_realation` VALUES (12, 1, 1, 1, 1, 1, 12);
INSERT INTO `vm_roles_menus_realation` VALUES (13, 1, 1, 1, 1, 1, 13);
INSERT INTO `vm_roles_menus_realation` VALUES (14, 2, 2, 1, 1, 1, 14);
