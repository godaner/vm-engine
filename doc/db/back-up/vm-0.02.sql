...
CREATE TABLE `vm_files` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `fileName` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '图片名,如a.png',
  `originalName` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '文件原名',
...
-- ----------------------------
INSERT INTO `vm_movies` VALUES ('1', '电影a', '电影aaa', '厉害了', '1', '1', '1.0', '100', '12312', '123', '/img/1', '1', '1231', '123');
INSERT INTO `vm_movies` VALUES ('2', '电影b', 'bbb', '哈哈', '2', '123', '2.0', '1000', '123', '123', '/img/2', '1', '123', '123');
