...
CREATE TABLE `vm_filmmakers`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '电影人基本信息表(包括演员，导演等)' ROW_FORMAT = Compact;
...
INSERT INTO `vm_filmmakers` VALUES (11, '张大可', '张大可二号', '阿萨', 3, 2, 1520315656, '阿萨', '阿萨达', '/src/img/1052', 1521438866, 1521529510, 1, 1);
...
INSERT INTO `vm_filmmakers` VALUES (14, 'gg', 'ggg', '兽皇', 3, 1, 1525076849, '美国', '阿萨大大', '/src/img/-1', 1525336068, 1525336068, 1, 1);
...
CREATE TABLE `vm_movies`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '电影表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies` VALUES (24, 'V字仇杀队', 'V', 'V字仇杀队', 8, 1520935198, 10.0, 0, 123, '/src/img/1004', '/src/img/1003', 1521194400, 1524105826, 1, 1);
INSERT INTO `vm_movies` VALUES (25, '哈利波特-1', '哈利波特-1', '哈利波特-1', 9, 1520233248, 10.0, 0, 123, '/src/img/1002', '/src/img/1062', 1521529255, 1523249893, 1, 1);
...
INSERT INTO `vm_movies` VALUES (28, '两杆大烟枪', '两杆大烟枪', '两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪两杆大烟枪', 9, 1525155750, 10.0, 0, 120, '/src/img/1070', '/src/img/1066', 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies` VALUES (29, '123', '123', '123', 11, 1525070325, 10.0, 0, 123, '/src/img/1071', '/src/img/1069', 1525329533, 1525329533, 1, 1);
INSERT INTO `vm_movies` VALUES (30, '12313', '12313', '123', 9, 1525071174, 10.0, 0, 123, '/src/img/-1', '/src/img/-1', 1525330380, 1525336094, 1, 1);
...
CREATE TABLE `vm_movies_filmmakers_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 216 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影及其电影人表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (201, 24, 8, 1523249861, 1523249861, 2, 1);
...
INSERT INTO `vm_movies_filmmakers_realation` VALUES (207, 24, 8, 1524105826, 1524105826, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (208, 28, 11, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (209, 28, 12, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (210, 28, 9, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (211, 28, 13, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (212, 29, 9, 1525329534, 1525329534, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (213, 30, 12, 1525330380, 1525330380, 2, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (214, 30, 12, 1525336094, 1525336094, 1, 1);
INSERT INTO `vm_movies_filmmakers_realation` VALUES (215, 30, 14, 1525336094, 1525336094, 1, 1);
...
CREATE TABLE `vm_movies_src_version`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_src_version` VALUES (16, 1523626146, 1523626146, 2, 25, 1, '/src/video/1026', 2, 1);
INSERT INTO `vm_movies_src_version` VALUES (17, 1523626188, 1523626188, 3, 25, 1, '/src/video/1027', 2, 1);
INSERT INTO `vm_movies_src_version` VALUES (18, 1523627777, 1523627777, 2, 25, 1, '/src/video/1030', 2, 1);
...
INSERT INTO `vm_movies_src_version` VALUES (32, 1523946566, 1523946566, 3, 25, 1, '/src/video/1046', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (33, 1524104208, 1524104208, 2, 25, 1, '/src/video/1048', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (34, 1524105792, 1524105792, 2, 25, 1, '/src/video/1049', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (35, 1524549236, 1524549236, 2, 25, 1, '/src/video/1050', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (36, 1524549254, 1524549254, 2, 25, 1, '/src/video/1051', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (37, 1524979015, 1524979015, 2, 25, 1, '/src/video/1057', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (38, 1525265010, 1525265010, 2, 25, 1, '/src/video/1060', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (39, 1525273014, 1525273014, 2, 25, 1, '/src/video/1061', 1, 1);
INSERT INTO `vm_movies_src_version` VALUES (40, 1525400426, 1525400426, 2, 28, 1, '/src/video/1075', 1, 1);
...
CREATE TABLE `vm_movies_tags_realation`  (
  ...
  `status` tinyint(5) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态,1为正常，2为冻结',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 144 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '关系表-电影标签表' ROW_FORMAT = Compact;
...
INSERT INTO `vm_movies_tags_realation` VALUES (123, 24, 35, 1523249861, 1523249861, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (124, 24, 40, 1523249861, 1523249861, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (125, 24, 46, 1523249861, 1523249861, 2, 1);
...
INSERT INTO `vm_movies_tags_realation` VALUES (131, 24, 35, 1524105826, 1524105826, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (132, 24, 40, 1524105826, 1524105826, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (133, 24, 46, 1524105826, 1524105826, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (134, 28, 35, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (135, 28, 51, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (136, 28, 45, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (137, 28, 44, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (138, 28, 47, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (139, 28, 39, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (140, 28, 40, 1525328571, 1525328571, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (141, 29, 50, 1525329534, 1525329534, 1, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (142, 30, 35, 1525330380, 1525330380, 2, 1);
INSERT INTO `vm_movies_tags_realation` VALUES (143, 30, 35, 1525336094, 1525336094, 1, 1);
